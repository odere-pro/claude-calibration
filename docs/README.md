...
| [`self-calibration.md`](self-calibration.md) | How the plugin evaluates a setup — the four flows (doctor/audit/calibrate/diff), the 6-phase loop, worker subagents + models, signatures/dispatch, write-guards, and auditing this plugin against itself     |
